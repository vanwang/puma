...
public class CaptchaEngine extends ListImageCaptchaEngine {
	...
	private static final String RANDOM_WORD = "ABCDEFGHJKMNPQRSTUVWXYZ23456789";// 随机字符
	private static final String IMAGE_PATH = "./com/puma/core/security/captcha/img/";// 随机背景图片路径
