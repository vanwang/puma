...
public class DuplicatedAccountException extends AuthenticationException {
   //~ Constructors ===================================================================================================
...
/**
    ...
    */
   public DuplicatedAccountException(String msg, Object extraInformation) {
    ...
    * @param t root cause
    */
   public DuplicatedAccountException(String msg, Throwable t) {
       super(msg, t);
   }
}
