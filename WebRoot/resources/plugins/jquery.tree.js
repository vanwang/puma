...
/* wanggfan: _cb function is the "find" method. of course he can not find the node drag from outside of the tree */ 
if(_20 != null){
	if(_20.id != undefined){
...
_22(_23,false);
if($(this).hasClass("tree-node-top") || $(this).hasClass("tree-node-bottom")){
...
if(_1b.onDragOver.call(_19,this,_14(_19,_23))==true){
	$(this).droppable("enable");
}
...
/*wangfan  used to append node*/
if(_1b.onDragOver.call(_19,this,_14(_19,_27))!=false){
	_29(_27,_28,_2a);
}
...
//wangfan remove undefined exception
if($.data(_62,"tree")!=undefined)
{
